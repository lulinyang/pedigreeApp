      ...
      >
        <div :class="{node: true, hasMate: treeData.mate}">
          <div class="person" @click="$emit('click-node', treeData)">
            ...
            <div class="name">
              {{treeData.name}}
              <van-icon name="static/images/man.png" v-if="treeData.sex == 1" />
              <van-icon name="static/images/woman.png" v-else />
          ...
          <div class="person" v-if="treeData.mate" @click="$emit('click-node', treeData.mate)">
            ...
            <div class="name">
              {{treeData.mate.name}}
              <van-icon name="static/images/man.png" v-if="treeData.mate.sex == 1" />
              <van-icon name="static/images/woman.png" v-else />
            </div>
          </div>
        </div>
